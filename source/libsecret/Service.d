...
private import libsecret.Collection;
private import libsecret.Prompt;
private import libsecret.Schema;
private import libsecret.Value;
...
public class Service : DBusProxy
{
	 ...
	 *     result = the asynchronous result passed to the callback
	 *
	 * Returns: a newly allocated #SecretValue, which should be
	 ...
	 *     result = asynchronous result passed to callback
	 *
	 * Returns: the collection dbus object path, or %NULL if
